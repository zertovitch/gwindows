...
package body GNAVI_Templates.Embedded is
   ...
   is
      ...
      who_generates : constant String :=
         "--  Generated by: GNAVI ICG (Interactive Code Generator)." & NL & NL;
      
      initially_generated : constant String :=
         "--  This file has been initially generated because it was missing." & NL &
         "--  You can and may want to modify it." & NL &
         who_generates;
      ...
      case Template is
         ...
         when on_create_template =>
            return
               ...
               "--  and may be regenerated without notice." & NL &
               "--  DO NOT MODIFY IT !" & NL &
         ...
         when application_template =>
            return
               ...
               "   pragma Linker_Options (""@_Application_Lower_Name_@.coff"");" & NL &
               NL &
               "begin" & NL &
         ...
         when gnat_project_file_template =>
            return
               initially_generated &
               "project @_Application_Name_@ is" & NL &
               NL &
               "   for Source_Dirs use (""."") & external_as_list(""ADA_INCLUDE_PATH"", "";"");" & NL &
               "   for Main use (""@_Application_Lower_Name_@.adb"");" & NL &
               "   for Object_Dir use ""obj"";" & NL &
               "   for Exec_Dir use ""."";" & NL &
               "   for Create_Missing_Dirs use ""True"";  --  Flips by default the ""-p"" switch" & NL &
               NL &
               "   package Builder is" & NL &
               "      for Default_Switches (""ada"") use (""-j0"");  --  Use all cores" & NL &
               "   end Builder;" & NL &
               NL &
               "   Common_Compiler_Options := (""-g"");" & NL &
               NL &
               "   package Compiler is" & NL &
               "      for Default_Switches (""ada"") use Common_Compiler_Options;" & NL &
               "   end Compiler;" & NL &
               NL &
               "   package Binder is" & NL &
               "      for Default_Switches (""ada"") use (""-Es"");  --  Symbolic tracebacks" & NL &
               "   end Binder;" & NL &
               NL &
               "end @_Application_Name_@;";

         when manifest_template =>
            return
               "<?xml version=""1.0"" encoding=""UTF-8"" standalone=""yes""?>" & NL &
               "<assembly xmlns=""urn:schemas-microsoft-com:asm.v1"" manifestVersion=""1.0"">" & NL &
               "<dependency>" & NL &
               "<dependentAssembly>" & NL &
               "<assemblyIdentity type=""win32"" name=""Microsoft.Windows.Common-Controls"" " & 
               "version=""6.0.0.0"" processorArchitecture=""*"" publicKeyToken=""6595b64144ccf1df"" language=""*""/>" & NL &
               "</dependentAssembly>" & NL &
               "</dependency>" & NL &
               "</assembly>";

         when resource_compiler_file_template =>
            return
               Ada.Strings.Fixed.Translate
                  (initially_generated, Ada.Strings.Maps.To_Mapping ("-", "/")) &  --  C-style comments.
               "#include <windows.h>" & NL & NL &
