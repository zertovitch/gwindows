...
with MSHTML.IHTMLWindow2_Object; use MSHTML.IHTMLWindow2_Object;
with MSHTML.IHTMLScreen_Object; use MSHTML.IHTMLScreen_Object;
with MSHTML.IHTMLInputButtonElement_Object;
use MSHTML.IHTMLInputButtonElement_Object;
...
package body Browser is
   ...
   begin
      ...
      Put_Width (Explorer, To_VARIANT (510));
      Put_Height (Explorer, To_VARIANT (250));
      ...
      Navigate (Explorer, To_VARIANT ("res://" &
   ...
   begin
      ...
      begin
         ChangeTitle (HWND  => To_Ada (Get_HWND (Explorer)),
                      Title => Title);
      end;

      SetIcon (HWND => To_Ada (Get_HWND (Explorer)),
   ...
   begin
      ...
      Put_Top (Explorer, To_VARIANT (0));
      Put_Left (Explorer,To_VARIANT (0));
      Put_Width (Explorer, Get_availWidth (Screen));
      Put_Height (Explorer, Get_availHeight (Screen));

      Put_InnerHTML (Element, To_VARIANT
                     ("<IMG SRC=""act.gif""> " &
