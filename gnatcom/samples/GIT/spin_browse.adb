...
package body Spin_Browse is
   ...
   Cookie     : GNATCOM.Interface.GIT_Cookie;
   --  HTML objects
   ...
   begin
      ...
      --  GNATCOM.Interface.Remove_From_GIT (Cookie);
   ...
   task body Spin_Task is
      ...
      TSpin : ISGrfxCtl_Type;
   begin
      accept Start;
      Initialize_COM;

      Attach_From_GIT (TSpin,
                       Cookie);
      loop
         select
            accept Stop;
