  ...
  type YYSType is record
    ...
    type Token is
        (End_Of_Input, Error, Number, Float_T,
         ...
         Ss_Realsizeimage_T, Ss_Left_T, Es_Multiline_T,
         Es_Readonly_T, Es_Autohscroll_T, Es_Autovscroll_T,
         Es_Wantreturn_T, Es_Number_T, Es_Center_T,
         Es_Right_T, Es_Password_T, Es_Uppercase_T,
         Es_Oemconvert_T, Bs_Lefttext_T, Bs_Autoradiobutton_T,
         Bs_3state_T, Bs_Autocheckbox_T, Bs_Bitmap_T,
         Bs_Ownerdraw_T, Bs_Bottom_T, Bs_Flat_T,
         Bs_Left_T, Bs_Right_T, Bs_Center_T,
         Bs_Vcenter_T, Bs_Pushlike_T, Bs_Top_T,
         Bs_Multiline_T, Bs_Defpushbutton_T, Bs_Radiobutton_T,
         Cbs_Simple_T, Cbs_Dropdown_T, Cbs_Dropdownlist_T,
         Cbs_Sort_T, Cbs_Hasstrings_T, Cbs_Autohscroll_T,
         Cbs_Disablenoscroll_T, Cbs_Ownerdrawfixed_T, Lbs_Sort_T,
         Lbs_Multiplesel_T, Lbs_Multicolumn_T, Lbs_Nointegralheight_T,
         Lbs_Usetabstops_T, Lbs_Notify_T, Lbs_Extendedsel_T,
         Lbs_Disablenoscroll_T, Lbs_Nosel_T, Lbs_Ownerdrawfixed_T,
         Lbs_Hasstrings_T, Pbs_Vertical_T, Sbs_Vert_T,
         Tbs_Noticks_T, Tbs_Autoticks_T, Tbs_Vert_T,
         Tbs_Top_T, Tbs_Bottom_T, Tbs_Tooltips_T,
         Tbs_Both_T, Uds_Horz_T, Uds_Arrowkeys_T,
         Uds_Wrap_T, Uds_Nothousands_T, Lvs_Alignleft_T,
         ...
         Tvs_Notooltips_T, Dts_Rightalign_T, Mcs_Notoday_T,
         Tcs_Hottrack_T, Ws_Ex_Clientedge_T, Ws_Ex_Staticedge_T,
