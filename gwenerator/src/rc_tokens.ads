  ...
  type YYSType is record
    ...
    type Token is
        (End_Of_Input, Error, Number, Float_T,
         ...
         Ss_Realsizeimage_T, Es_Multiline_T, Es_Readonly_T,
         Es_Autohscroll_T, Es_Autovscroll_T, Es_Wantreturn_T,
         Es_Number_T, Es_Center_T, Es_Right_T,
         ...
         Bs_Bottom_T, Bs_Flat_T, Bs_Left_T,
         Bs_Right_T, Bs_Center_T, Bs_Vcenter_T,
