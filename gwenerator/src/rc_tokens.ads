  ...
  type YYSType is record
    ...
    type Token is
        (End_Of_Input, Error, Number, Float_T,
         ...
         Ws_Clipsiblings_T, Ws_Clipchildren_T, Ws_Sizebox_T,
         ...
         Es_Password_T, Es_Uppercase_T, Es_Oemconvert_T,
         Es_Nohidesel_T, Bs_Lefttext_T, Bs_Autoradiobutton_T,
         Bs_3state_T, Bs_Checkbox_T, Bs_Autocheckbox_T,
         ...
         Bs_Pushbutton_T, Bs_Radiobutton_T, Bs_Auto3state_T,
         Bs_Text_T, Cbs_Simple_T, Cbs_Dropdown_T,
         ...
         Uds_Nothousands_T, Uds_Setbuddyint_T, Lvs_Alignleft_T,
         Lvs_Icon_T, Lvs_Report_T, Lvs_Showselalways_T,
         Lvs_Sortascending_T, Lvs_Autoarrange_T, Lvs_Nosortheader_T,
         Lvs_List_T, Lvs_Singlesel_T, Tvs_Infotip_T,
         ...
         Tvs_Trackselect_T, Dts_Rightalign_T, Mcs_Notoday_T,
         Tcs_Hottrack_T, Tcs_Buttons_T, Gs_Columnlabels_T,
         ...
         Ws_Ex_Dlgmodalframe_T, Idc_Static_T, Ident_T,
