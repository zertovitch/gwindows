  ...
  type YYSType is record
    ...
    type Token is
        (End_Of_Input, Error, Number, Float_T,
         ...
         Ss_Left_T, Ss_Right_T, Es_Multiline_T,
         ...
         Sbs_Vert_T, Tbs_Noticks_T, Tbs_Autoticks_T,
         Tbs_Vert_T, Tbs_Top_T, Tbs_Bottom_T,
         Tbs_Tooltips_T, Tbs_Both_T, Uds_Horz_T,
         Uds_Arrowkeys_T, Uds_Wrap_T, Uds_Nothousands_T,
         Lvs_Alignleft_T, Lvs_Icon_T, Lvs_Report_T,
         Lvs_Showselalways_T, Lvs_Sortascending_T, Lvs_Autoarrange_T,
         Lvs_Nosortheader_T, Lvs_List_T, Lvs_Singlesel_T,
         Tvs_Infotip_T, Tvs_Noscroll_T, Tvs_Haslines_T,
         Tvs_Showselalways_T, Tvs_Hasbuttons_T, Tvs_Linesatroot_T,
         Tvs_Notooltips_T, Tvs_Editlabels_T, Dts_Rightalign_T,
         Mcs_Notoday_T, Tcs_Hottrack_T, Gs_Columnlabels_T,
