  ...
  type YYSType is record
    ...
    type Token is
        (End_Of_Input, Error, Number, Float_T,
         ...
         Lvs_List_T, Tvs_Infotip_T, Tvs_Noscroll_T,
         Tvs_Haslines_T, Tvs_Showselalways_T, Tvs_Hasbuttons_T,
         Tvs_Linesatroot_T, Tvs_Notooltips_T, Dts_Rightalign_T,
         Mcs_Notoday_T, Tcs_Hottrack_T, Ws_Ex_Clientedge_T,
         ...
         Ws_Ex_Topmost_T, Idc_Static_T, Ident_T,
