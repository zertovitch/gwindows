...
\noindent {\bf base}\_shift\_reduce.ada  {\bf base}\_goto.ada
...
{\it Extension} specifies the file extension to be used for generated Ada files.
...
\\
\>  Literals : {\bf constant} Table := Table'(\>\>\>\>0 $=>$ END\_OF\_INPUT,\\
\>\>\>\>\>                                      40     $=>$ '(',\\
\>\>\>\>\>                                      41     $=>$ ')',\\
\>\>\>\>\>                                      61     $=>$ '=',\\
\>\>\>\>\>                                      43     $=>$ '+',\\
